...
public partial class NvuBhtCtu
{
    ...
    public string MaLdonhang { get; set; } = null!;

    public bool WetRisk { get; set; }

    public bool TbhTt { get; set; }

    public int MauLogo { get; set; }

    public string? TenGroup { get; set; }

    public string? DkNhakhoa { get; set; }

    public bool ChkWf { get; set; }

    public string? PheDuyetdv { get; set; }
    ...
    public string DiengiaiTonthat { get; set; } = null!;

    public string CosoNguyhiemCnbb { get; set; } = null!;
}
